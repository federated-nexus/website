...
[Forgejo](https://forgejo.org) is a free and open-source git forge. Very lightweight and performant, Forgejo is a good replacement for GitHub. Federated Nexus provides a hosted instance at https://git.federated.nexus.
