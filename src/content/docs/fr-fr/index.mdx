...
<CardGrid>
    ...
    <Card title="Communications privées et libres" icon="comment">
        [Matrix](https://matrix.org) est une plateforme de communication open source. Sur Federated Nexus, elle est représentée par une instance basée sur un logiciel libre [Continuwuity](https://continuwuity.org/). Nous proposons également différents ponts, notamment des marionnettes pour WhatsApp et SMS ! [En savoir plus...](services/matrix)
    </Card>
